...
public class ParserUtil {
	public static String full() {
		Cell currentCell = PrintMap.currentLevel.contents[Player.xPos][Player.yPos];
		String toRet = "";
		if (currentCell.beenThere) {
			toRet += currentCell.beenText;
		} else {
			toRet += currentCell.normText;
		}
		toRet += "\nThese items are in the room:";
		for (Item i : currentCell.cellItems) {
			toRet += "\n";
			toRet += i.getName();
		}
